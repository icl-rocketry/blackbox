...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  ...
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2021a\\toolbox\\target\\supportpackages\\android\\+codertarget\\+internal\\androidDataDisplay.p"/* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
...
static void cgxe_mdl_set_sim_state(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_TTLCUDajK4f7O0CW8HSrh
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_TTLCUDajK4f7O0CW8HSrh(SimStruct *S, int_T tid)
{
  InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance =
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_TTLCUDajK4f7O0CW8HSrh(SimStruct *S)
{
  InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance =
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_TTLCUDajK4f7O0CW8HSrh(SimStruct *S, int_T tid)
{
  InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance =
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_TTLCUDajK4f7O0CW8HSrh(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance =
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *)cgxertGetRuntimeInstance(S);
...
static void setSimState_TTLCUDajK4f7O0CW8HSrh(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance =
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_TTLCUDajK4f7O0CW8HSrh(SimStruct *S)
{
  InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance =
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_TTLCUDajK4f7O0CW8HSrh(SimStruct *S)
{
  InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance =
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_TTLCUDajK4f7O0CW8HSrh(SimStruct *S)
{
  InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance =
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_TTLCUDajK4f7O0CW8HSrh(SimStruct *S)
{
  InstanceStruct_TTLCUDajK4f7O0CW8HSrh *moduleInstance =
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh *)calloc(1, sizeof
    (InstanceStruct_TTLCUDajK4f7O0CW8HSrh));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_TTLCUDajK4f7O0CW8HSrh);
  ssSetmdlInitializeConditions(S, mdlInitialize_TTLCUDajK4f7O0CW8HSrh);
  ssSetmdlUpdate(S, mdlUpdate_TTLCUDajK4f7O0CW8HSrh);
  ssSetmdlTerminate(S, mdlTerminate_TTLCUDajK4f7O0CW8HSrh);
  ssSetmdlEnable(S, mdlEnable_TTLCUDajK4f7O0CW8HSrh);
  ssSetmdlDisable(S, mdlDisable_TTLCUDajK4f7O0CW8HSrh);
...
static void mdlProcessParameters_TTLCUDajK4f7O0CW8HSrh(SimStruct *S)
{
}

void method_dispatcher_TTLCUDajK4f7O0CW8HSrh(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_TTLCUDajK4f7O0CW8HSrh(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_TTLCUDajK4f7O0CW8HSrh(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_TTLCUDajK4f7O0CW8HSrh(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_TTLCUDajK4f7O0CW8HSrh(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: TTLCUDajK4f7O0CW8HSrh.\n"
...
mxArray *cgxe_TTLCUDajK4f7O0CW8HSrh_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_TTLCUDajK4f7O0CW8HSrh_fallback_info(void)
{
